...
Comprehensive git worktree management for creating isolated working directories for branches and pull requests.

## Create Worktrees for All Open PRs

Creates a git worktree for each open PR branch in `./tree/<BRANCH_NAME>` directory.
...
Interactive command to create new branch with corresponding worktree:
...
## Features:
- **PR Integration**: Automatically creates worktrees for all open GitHub PRs
- **Slash Handling**: Properly handles branch names with slashes (creates directory structure)
- **Duplicate Prevention**: Checks for existing worktrees before creating new ones
- **Cleanup Tools**: Removes stale worktrees for deleted branches
- **Interactive Creation**: Guided branch and worktree creation
- **Validation**: Input validation and error handling

## Author Information:
- **Author**: evmts
- **Source**: https://github.com/evmts/tevm-monorepo/blob/main/.claude/commands/create-worktrees.md
- **License**: MIT